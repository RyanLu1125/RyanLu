...
<body>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<table id="updateEvent">
										...
										<tr>
											<td>活動圖檔 : <input type="file" id="imageUpdate" name="eventImage1" multiple="multiple" accept=".png, .jpg, .jpeg"/><img  name="eventImage2" alt="" src="" width="200" height="100">	</td>
										</tr>
										<tr>
	...
	<script type="text/javascript">
							...
							$.ajax({
										...
										success : function(response) {
											...
											for (let i = 0; i < response.length; i++) {
												...
												txt += "<td><img src='data:image/jpeg;base64," + response[i].eventImage + "'  width='200' height='100'>"
		...
		$(document).on('click', '#SaveButton', function() {
			...
			updateImage =$('#imageUpdate').get(0).files[0];			
