	...
	<table id="table1">
		...
		<c:forEach var="product" items="${products}">
			<tr>
				...
				<td>${product.tag}</td>
				<td><img alt="picture"
					src="${pageContext.servletContext.contextPath}/productImage.do?Id=${product.productId}"
					width="112"></td>
				<td><input name="wish" type="button" value="許願"> <input
					type="button" value="評價"> <input name="cart" type="button"
					value="加入購物車"></td>
			</tr>
		</c:forEach>
	</table>
